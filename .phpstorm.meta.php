...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\ultra\OneDrive\Documents\schoolshit\uni\internship\work\KTHRM.1 - Copy\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\ultra\\OneDrive\\Documents\\schoolshit\\uni\\internship\\work\\KTHRM.1 - Copy\\public\\storage','logging.default','logging.deprecations.channel',
...
'hashing.rehash_on_login','view.paths','view.compiled','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'web','api',);
        registerArgumentsSet('routes', 'welcome','book','birthday',
'forgot','forgot.check','forgot.reset','login.post','dashboard',
'logout','employees','past.employees','employees.store','employees.filter',
'personal.filter','employees.search','employees.show','employees.edit','employees.update',
'uploadFile','employees.unassignAsset','employees.assignAsset','terminate.form','terminate',
'uploademp.form','uploadfam.form','upload.emp','upload.family','users.index',
'users.create','users.store','users.edit','users.update','users.destroy',
'family.index','family.store','jobs.index','jobs.store','jobs.edit',
'jobs.update','jobs.destroy','assets.index','assets.store','assets.edit',
'assets.update','assets.destroy','assets.upload','upload.assets','assets.template.download',
'asset-categories.index','asset-categories.create','asset-categories.store','asset-categories.show','asset-categories.edit',
'asset-categories.update','asset-categories.destroy','assets.assign','assets.unassign','assets.search',
'assets.filter','company.index','company.create','company.store','company.show',
'company.edit','company.update','company.destroy','company.employees','kpi.index',
'kpi.create','kpi.store','kpi.show','kpi.edit','kpi.update',
'kpi.destroy','kpi.accept','kpi.request-revision','pms-dashboard','department.index',
'department.store','department.edit','department.update','department.destroy','department.employees',
'login','register','password.request',
'password.email','password.reset','password.update','password.confirm',
'home','users.validateField','users.validateEditField','company.validateField',
'company.validateEditField','login.validate','department.validateField','department.validateEditField',);
        registerArgumentsSet('views', 
'assets.category','assets.details','assets.edit','assets.index','assets.test',
'assets.uploadasset','auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset',
'auth.register','auth.verify','company.edit','company.employee','company.index',
'dashboard','department.edit','department.employee','department.index','details',
'edit','employees','employees-past','family','forgot',
'home','jobs.edit','jobs.index','jobs.remove','layout',
'layouts.app','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'partials.accept-kpi-modal','partials.error','partials.footer','partials.logout-modal','partials.photo',
'partials.sidebar','partials.topbar','personal','pms.dashboard','pms.kpi.create',
'pms.kpi.edit','pms.kpi.index','pms.kpi.show','profile.personal','profile.work',
'spare','terminate','test','test.book','uploademp',
'uploadfam','user.edit','user.index','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5',
...
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.ultra.OneDrive.Documents.schoolshit.uni.internship.work.KTHRM.1 - Copy.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
