                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-bordered">
                                    ...
                                    <tr><th>PC Name</th><td data-field="pc_name"></td></tr>
...
$(document).on('click', '.view-asset-btn', function () {
    ...
    // Fill asset ID in hidden form input
    ...
    const fields = [
        'asset_id', 'pc_name', 'assigned_to', 'department', 'type', 'status', 'model', 'cpu',
        'ram', 'hdd', 'hdd_bal', 'hdd2', 'hdd2_bal', 'ssd', 'ssd_bal', 'sn_no',
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.success) {
                ...
                const $rowBtn = $('.view-asset-btn[data-asset_id="' + assetId + '"]');
                const $row = $rowBtn.closest('tr');
                $row.find('td').eq(3).text(fullName);
                $row.find('td').eq(4).text(employee.department);
