...
@section('content')
    <div class="container-fluid">
            ...
            <form class="grid gap-4 p-3 rounded shadow-md" style="background-color: #ffffff;">
                ...
                <ul class="nav nav-tabs mt-2" id="profileTabs" role="tablist">
                    ...
                    @if(in_array(auth()->user()->access, ['Admin', 'HR', 'Technical']))
                        <li class="nav-item">
                            <a class="nav-link {{ request('tab') === 'asset' ? 'active' : '' }}" id="asset-tab"
                                data-toggle="tab" href="#asset" role="tab" aria-controls="asset"
                                aria-selected="{{ in_array(auth()->user()->access, ['Technical']) ? 'true' : 'false' }}">Asset</a>
                        </li>
                    @endif
                </ul></br>
                <!-- Tab content -->
                        ...
                        <div class="tab-pane fade show active" id="work" role="tabpanel" aria-labelledby="work-tab">
                            ...
                            <div class="col-span-2 grid grid-cols-2 gap-2">
                                ...
                                <div class="label-box-container">
                                    ...
                                    <input type="text"
                                        value="{{ $employee->expiry_date ? $employee->expiry_date->format('d-m-Y') : 'N/A'}}"
                                        class="input-field" readonly>
                                </div>
                                <div class="label-box-container">
                                            ...
                                            @foreach($assignedAssets as $index => $assignment)
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                        data-target="#unassignModal" data-assetid="{{ $assignment->asset->id }}"
        ...
        'firstName' => str_replace(' ', '_', $employee->first_name)
                        ...
                        style="color: #00aeef; border: 1px solid #00aeef; font-weight: bold;">Edit</a>
                </div>
            </div>
        </ul>
    </div>
