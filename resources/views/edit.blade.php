...
@section('content')
    <div class="container-fluid">
    ...
    ]) }}" class="grid gap-4 p-3 rounded shadow-md" style="background-color: #ffffff;"
                    ...
                    <div class="profile-container">
                        ...
                        <div class="profile-image"
                            ...
                            <label for="photoInput" style="width: 100%; height: 100%; display: block;">
                                ...
                                @if($employee->photo)
                                    <img id="photoPreview" src="data:image/jpeg;base64,{{ base64_encode($employee->photo) }}"
                                        alt="Employee Photo" style="width: 100%; height: 100%; object-fit: cover;">
                                @else
                            ...
                            <div id="fileNameDisplay"
                                style="text-align: center; margin-top: 10px; font-size: 0.9rem; color: #333;"></div>
                        </div>
                    </div>
                ...
                <div class="tab-content" id="profileContent">
                    ...
                    <div class="tab-pane fade" id="work" role="tabpanel" aria-labelledby="work-tab">
                        ...
                        <div class="col-span-2 grid grid-cols-2 gap-2">
                            ...
                            <div class="label-box-container">
                                <label class="label-box text-sm font-bold">Expiry Date:</label>
                                <input type="text" name="expiry_date"
                                    value="{{ $employee->expiry_date ? $employee->expiry_date->format('d-m-Y') : ''}}"
                                    class="input-field">
                            </div>
                            <div class="label-box-container">
        ...
        'employmentStatus' => $employee->employment_status,
        'firstName' => str_replace(' ', '_', $employee->first_name)
    ]) }}" class="btn" style="color: #ffffff; background-color: #f44336;">Cancel</a>
